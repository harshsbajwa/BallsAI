  ...
  create  table "nba_pipeline"."marts"."player_season_stats__dbt_tmp"
...
from "nba_pipeline"."staging"."stg_player_statistics" pss
join "nba_pipeline"."staging"."stg_players" p on pss.person_id = p.person_id
join "nba_pipeline"."staging"."stg_teams" t on pss.team_id = t.team_id
group by 1, 2, 3, 4, 5
  );
